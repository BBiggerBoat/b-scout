...
for r in data:
    ...
    if bid=='TPMC-32-EA':
        ...
        unresolved.append('Many boats carry a separate auxiliary/wing engine; EngineCount remains 1 because B-Scout uses the principal propulsion-engine count for this field.')
    r['ModelVariations']=variations
    r['ResearchStatus']='Reviewed'; r['DataConfidence']='Moderate'; r['ReviewedBy']='B-Scout Phase 8C-17 Specialist / Isolated Models Research'; r['LastUpdated']='2026-08-07'; r['Revision']=max(2,int(r.get('Revision') or 1)+1)
