...
const C={
 ...
 'CPDR-28-CR':{
  ...
  inspect:inspect28,
  variations:[{Name:'Factory designation',Description:'Cape Dory factory literature calls this configuration the CD/28 Cruiser or 28 Power Cruiser. B-Scout uses “28 Power Cruiser” to distinguish it from the unrelated Cape Dory 28 sailboat.',AffectedYears:'Production run',EvidenceRefs:[S.factory28,S.factory91],Confidence:'High'},{Name:'Flybridge relationship',Description:'The Flybridge Cruiser is the same core cruising configuration with the factory flybridge added; it remains a separate B-Scout variant because height, access and use differ materially.',AffectedYears:'Production run',EvidenceRefs:[S.factory28,S.factory91],Confidence:'High'},{Name:'Power options',Description:'Factory and valuation sources document both gasoline and diesel single-inboard options.',AffectedYears:'Production run',EvidenceRefs:[S.factory28,S.jd86],Confidence:'High'}],
 ...
 'CPDR-36-TR':{
  ...
  sources:[S.hmy36,S.history,S.jd92], unresolved:['Later Newport-era 36 examples create a production-year conflict; B-Scout retains the well-documented 1988–1990 Cape Dory 36 Flybridge range pending hull-by-hull confirmation']
 },
 'CPDR-40-TR':{
  ...
  inspect:inspect40,
  variations:[{Name:'Production chronology',Description:'Factory history places hull #1 in 1992; HMY documents 1992–1994 production, while a verified 1995 HIN/listing demonstrates at least one 1995 example. B-Scout therefore carries 1992–1995 with hull-specific verification.',AffectedYears:'1992–1995',EvidenceRefs:[S.history,S.hmy40],Confidence:'High'},{Name:'Published dimensions',Description:'Factory and technical references support 40 ft model length, 13 ft 10 in beam and 3 ft 9 in draft, while some brokerage records report different overall lengths or beams. Individual HIN documentation controls.',AffectedYears:'Production run',EvidenceRefs:[S.factory91,S.hmy40],Confidence:'High'}],
  sources:[S.factory91,S.hmy40,S.history], unresolved:['Holding-tank capacity is not assigned because reliable sources reviewed do not provide a consistent figure','Some brokerage records report 44 ft overall including appendages; B-Scout retains the documented 40 ft model length and records the discrepancy as hull-specific']
 }
};
...
for(const m of models){
 ...
 m.ResearchStatus='Reviewed'; m.DataConfidence='Moderate'; m.ReviewedBy='B-Scout Cape Dory Family Research'; m.LastUpdated=today; m.Revision=(m.Revision||1)+1;
